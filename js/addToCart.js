...
$(document).ready(function () {
  ...
  $(".addItemToCart").click(function () {
    ...
    if (!pimage || pimage.trim() === "") {
      console.error("Image source is empty! Check HTML structure.");
      return;
    }
