...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const wishlistButtons = document.querySelectorAll(".AddWishlist");
        ...
        popup.innerHTML = `
            <div class="popup-overlay">
                <div class="popup-box">
                    ...
                    <p>You need to log in first to add items to your cart or wishlist.</p>
    ...
    function checkLogin(event) {
        ...
        if (!isLoggedIn) {
            ...
            let action = this.classList.contains("addItemToCart") ? "cart" : "wishlist";
    ...
    wishlistButtons.forEach(btn => btn.addEventListener("click", checkLogin));
});
</script>
