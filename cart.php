...
<?php
                            ...
                            <tr>
                                <td class="product_list">
                                    <div class="ImageAndName">
                                        <div class="image">
                                        <img src="<?php echo $values['product_image']; ?>" alt="Product Image">
                                ...
                                <?php
                                    ...
                                    if( $values['product_toppings'] == '') 
                                        ...
                                        <?php   
                                            ...
                                            $toppings_price += floatval($row['topping_price']);
    ...
    <div class="quantity-controls">
        <button class="minus-btn" data-id="<?php echo $values['product_id']; ?>">-</button>
        <span class="quantity" id="quantity_<?php echo $values['product_id']; ?>"><?php echo $values["product_quantity"]; ?></span>
        <button class="plus-btn" data-id="<?php echo $values['product_id']; ?>">+</button>
    </div>
</td>

                                
                                <td><?php echo $toppings_price ?></td>

                                <td style="color: var(--green)"><b>₹ <?php echo $total_item_price ?> </b></td>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="color: var(--green)"><b>₹ <?php echo $total ?> </b></td>    
                            </tr>
...
.quantity-controls button {
    width: 25px;
    height: 25px;
    background: blue; /* Orange background */
    color: white;
    border: none;
    cursor: pointer;
    font-size: 18px;
...
.quantity-controls button:hover {
    background:rgb(0, 31, 204); /* Darker orange on hover */
}
